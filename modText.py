...
class App(QWidget):
    ...
    def descargar_kml(self):
        ...
        if numero_padron or archivo_seleccionado:
            carpeta_descarga = os.path.join('C:/.../Proyecto MapaAUT', nombre_carpeta)
        ...
        ruta_descarga = f'C:/.../Proyecto MapaAUT/{nombre_carpeta}/padron_{numero_padron}.kml'
    ...
    def procesar_datos(self):
        ...
        if dissolved_with_areaperc :
            ...
            output_file = f'C:/Users/.../Proyecto MapaAUT/{nombre_carpeta}/padron_{numero_padron}_Int'
        else: 
        ...
        if dissolved_unique_with_areaperc :
            # Guardar el archivo resultante en formato shp
            output_file = f'C:/Users/.../{nombre_carpeta}/padron_{numero_padron}_Int_Dis'
            output_file2 = f'C:/Users/.../{nombre_carpeta}/padron_{numero_padron}_Int'
            output_file3 = f'C:/Users/.../{nombre_carpeta}/padron_{numero_padron}.kml'
        ...
        kml_layer = QgsVectorLayer(output_file3, f"{numero_padron}_padron.kml", "ogr")
        ...
        if centroide:
            self.ajustar_cuadro_a_centroide("C:/Users/.../Cuadro.shp", centroide)

    

    def modificar_nombre_titulo(self):
        ruta_qpt = r'C:\Users\...\Plantilla.qpt'
    ...
    def modificar_referencias(self):
        ...
        layer_path = f'C:/Users/.../{nombre_carpeta}/padron_{numero_padron}_Int_Dis.shp'
    ...
    def modificar_referencias_otbn(self):
        ...
        # Suponiendo que dissolved_unique_with_areaperc es una referencia válida a tu capa
        layer_path = f'C:/Users/.../Proyecto MapaAUT/{nombre_carpeta}/padron_{numero_padron}.kml'
        layer = QgsVectorLayer(layer_path, "layer", "ogr")
        layer_path2= f'C:/Users/.../{nombre_carpeta}/padron_{numero_padron}_Int.shp'
        layer2 = QgsVectorLayer(layer_path2, "layer2", "ogr")
                        
        # Verificar si la capa es válida
        if not QgsVectorLayer.isValid(layer):
            print("La primera capa no es válida")
        else:
            print("La primera capa es válida")
        ...
        # Iterar sobre las características de la capa
        for feature in layer_diss_area['OUTPUT'].getFeatures():
            # Obtener el valor del atributo 'sup_ha'
            valor_sup_ha = feature['sup_ha']
                        ...
                        for option in custom_properties.findall('Option'):
                            if option.get ('type') == 'Map':
                                for sub_option in option.findall('Option'):
                                    ...
                                    elif sub_option.get('name') == 'legend/label-0':
                                        sub_option.set('value', nuevo_texto2)
                                    elif sub_option.get('name') == 'legend/label-1':
                                        sub_option.set('value', nuevo_texto3)
                                    elif sub_option.get('name') == 'legend/label-2':
                                        sub_option.set('value', nuevo_texto4)
                                    elif sub_option.get('name') == 'legend/label-3':
                                        sub_option.set('value', nuevo_texto5)
                                    elif sub_option.get('name') == 'legend/label-4':
